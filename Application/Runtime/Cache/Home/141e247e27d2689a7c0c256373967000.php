    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget flat">
            ...
            <div class="widget-body">
                ...
                <?php if($type == 1): elseif($type == 2): ?>
                    <div class="form-group">
                        <label class="col-sm-2 control-label text-align-right form_label">选择一级代理：</label>
                        <select id="one">
                ...
                <?php else: ?>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label text-align-right form_label">选择二级代理：</label>
                        <select id="two">
                ...
                <a class="btn btn-blue shiny save_info" user="<?php echo ($user_id); ?>" to-url="<?php echo U('Admin/agency_info');?>" save_url="<?php echo U('Admin/edit_info');?>" url="<?php echo U('Admin/add_user');?>">提交</a>
...
<script src="/stock_trade/Public/Home/Js/hint.js"></script>
    ...
    <script src="/stock_trade/Public/Home/Js/add_agency.js"></script>
