            ...
            <div class="widget-body">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseOne" class="panel-collapse collapse">
                                <div class="panel-body">
                                    ...
                                    <select id="grade_id" data="<?php echo ($where); ?>">
                                    ...
                                    <button id="seek" type="button" class="btn btn-primary" url="<?php echo U('Admin/son_agency');?>" style="padding: 7px; margin-top: -3px;">
                ...
                <table class="table_data table table-striped table-hover table-bordered">
                    ...
                    <?php if(is_array($user_info)): foreach($user_info as $key=>$vo): ?><tr>
                            ...
                            <td>
                                <?php if($vo["grade_id"] != 3): ?><a class="subordinate" grade="<?php echo ($vo["grade_id"]); ?>" user="<?php echo ($vo["id"]); ?>" href="javascript:void(0);">下一级</a><?php endif; ?>
                            </td>
...
<script>
    ...
    <script src="/stock_trade/Public/Home/Js/son_agency.js"></script>
