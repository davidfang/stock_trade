        ...
        <div class="widget flat">
            ...
            <div class="widget-body">
                ...
                <div class="form-group">
                    <label for="identity_card" class="col-sm-2 control-label text-align-right form_label">身份：</label>
                    <span class="col-sm-10 control-content"><?php echo ($user_info['grade_name']); ?></span>
                </div>
                <div class="form-group">
                ...
                <a class="btn btn-blue shiny save_info" user="<?php echo ($user_id); ?>" to-url="<?php echo U('Admin/agency_info');?>" url="<?php echo U('Admin/edit_agency');?>">提交</a>
...
<script src="/stock_trade/Public/Home/Js/hint.js"></script>
    ...
    <script src="/stock_trade/Public/Home/Js/edit_agency.js"></script>
