        ...
        <div class="widget flat">
            ...
            <div class="widget-body">
                <div class="form-group">
                    <label class="col-sm-2 control-label text-align-right">姓名：</label>
                    <span class="col-sm-10 control-label"><?php echo ($user['name']); ?></span>
                </div>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label text-align-right">身份证号：</label>
                    <span class="col-sm-10 control-label"><?php echo ($user['identity_card']); ?></span>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label text-align-right">email：</label>
                    <span class="col-sm-10 control-label"><?php echo ($user['email']); ?></span>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label text-align-right">地址：</label>
                    <span class="col-sm-10 control-label"><?php echo ($user['address']); ?></span>
                </div>

                <a href="<?php echo U('Personal/edit_personal_info');?>" class="btn btn-blue shiny edit_info">修改资料</a>
            </div><!--Widget Body-->
        </div><!--Widget-->
    </div>
