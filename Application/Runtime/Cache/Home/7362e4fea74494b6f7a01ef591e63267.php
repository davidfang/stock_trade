        ...
        <div class="widget flat">
            ...
            <div class="widget-body">
                <div class="form-group">
                    ...
                    <input type="text" maxlength="5" class="form-control form_text" value="<?php echo ($product['name']); ?>" name="name" id="name">
                </div>
                <a class="btn btn-blue shiny save_info" product="<?php echo ($product['id']); ?>" to-url="<?php echo U('Admin/product');?>" url="<?php echo U('Admin/add_save_product');?>">提交</a>
            </div><!--Widget Body-->
        </div><!--Widget-->
    </div>
