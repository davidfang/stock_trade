        ...
        <div class="widget flat">
            ...
            <div class="widget-body">
                <div class="form-group" style="margin-top: 40px;">
                    ...
                    <input type="text" maxlength="5" class="form-control form_text" value="<?php echo ($user_info['name']); ?>" name="name" id="name">
                </div>
                <div class="form-group">
                    <label for="identity_card" class="col-sm-2 control-label text-align-right form_label">身份证号：</label>
                    <input type="text" maxlength="18" class="form-control form_text" value="<?php echo ($user_info['identity_card']); ?>" name="identity_card" id="identity_card">
                </div>
                <div class="form-group">
                    <label for="phone" class="col-sm-2 control-label text-align-right form_label">手机号：</label>
                    <input type="tel" maxlength="11" class="form-control form_text" value="<?php echo ($user_info['phone']); ?>" name="phone" id="phone">
                </div>
                <div class="form-group">
                    <label for="email" class="col-sm-2 control-label text-align-right form_label">邮箱：</label>
                    <input type="text" class="form-control form_text" value="<?php echo ($user_info['email']); ?>" name="email" id="email">
                </div>
                <div class="form-group">
                    <label for="address" class="col-sm-2 control-label text-align-right form_label">地址：</label>
                    <input type="text" maxlength="100" class="form-control form_text" value="<?php echo ($user_info['address']); ?>" name="address" id="address">
                </div>
                <?php if($type == 'user'): ?><div class="form-group">
                        <label for="stock" class="col-sm-2 control-label text-align-right form_label">股票账号：</label>
                        <input type="text" maxlength="20" value="<?php echo ($user_info['stock']); ?>" placeholder="请输入股票账号" class="form-control form_text" name="stock" id="stock">
                    </div>
                    <div class="form-group">
                        <label for="stock_psd" class="col-sm-2 control-label text-align-right form_label">股票密码：</label>
                        <span class="input-icon icon-right form_text">
                            <input type="password" maxlength="16" value="<?php echo ($user_info['stock_psd']); ?>" placeholder="请输入股票账号密码" class="form-control" name="stock_psd" id="stock_psd">
                            <i class="fa fa-eye eye"></i>
                        </span>
                    </div><?php endif; ?>
                <a class="btn btn-blue shiny save_info" user="<?php echo ($user_id); ?>" to-url="<?php echo U('Admin/user');?>" save_url="<?php echo U('Admin/edit_info');?>" url="<?php echo U('Admin/add_user');?>">提交</a>
            </div><!--Widget Body-->
        </div><!--Widget-->
    </div>
...
<script src="/stock_trade/Public/Home/Js/hint.js"></script>
    ...
    <script src="/stock_trade/Public/Home/Js/add_user.js"></script>
