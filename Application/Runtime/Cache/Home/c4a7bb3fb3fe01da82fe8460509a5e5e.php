    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget flat">
            <div class="widget-header">
                <span class="widget-caption main_title">手续费信息</span>
            </div><!--Widget Header-->
            <div class="widget-body">
                <div class="form-group">
                    <label for="money" class="col-sm-2 control-label text-align-right form_label">手续费：</label>
                    <input type="number" min="0" class="form-control form_text" value="<?php echo ($poundage['money']); ?>" name="money" id="money">（元/次）
                </div>
                <a class="btn btn-blue shiny save_info" url="<?php echo U('Admin/poundage');?>">提交</a>
            </div><!--Widget Body-->
        </div><!--Widget-->
    </div>
